...
const AnimatedLaptopIcon = ({ onAnimationComplete }) => {
  return (
    ...
    >
      <motion.g
        stroke="#d462fe"
        strokeWidth="0.5" // İnce kalem ucu hissi
        strokeLinecap="round"
      ...
      >
        <motion.path
          ...
          initial={{ pathLength: 0, fill: "rgba(212, 98, 254, 0)" }}
          animate={{
            pathLength: 1,
            fill: "rgba(212, 98, 254, 1)", // Bitiş: Çizgi tam, Dolgu mor
          }}
          transition={{
            pathLength: { duration: 2.5, ease: "easeInOut" }, // Çizim süresi
            fill: { delay: 2.2, duration: 0.8, ease: "easeOut" }, // Çizim bitmeye yakın dolgu gelsin
          }}
        ...
        {!introFinished && (
          <div className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none">
            {isInView && (
              <AnimatedLaptopIcon
                onAnimationComplete={() => {
                  // Dolgu geldikten sonra biraz bekleyip sahneyi açıyoruz
