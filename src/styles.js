const styles = {
  ...
  padding: "xl:px-36 lg:px-16 md:px-25 sm:px-16 px-6 sm:py-16 py-10",
  padding2:"xl:pl-30 xl:pr-3 lg:px-16 md:px-25 sm:px-16 px-6 sm:py-16 py-10", // left and right padding decreased 
